...
python3 tools/eval_classification.py mnist train lenet snapshot/lenet_svhn

echo 'ADDA':
python3 tools/eval_classification.py mnist train lenet snapshot/adda_lenet_svhn_mnist
